...
if (bot) {
    ...
    bot.telegram.setMyShortDescription('Лучший бот для знакомств! ❤️ Найти друзей, общение, отношения и любовь. Ищи людей рядом, бесплатно и без ограничений.').catch(()=>{});
    bot.telegram.setMyDescription('Быстрые знакомства в Telegram! 🔥\n\nИщете друзей, приятное общение или вторую половинку? Наш чат-бот для знакомств поможет найти идеальную пару. Умный поиск по возрасту, городу и интересам.\n\nНикаких сложностей — создайте анкету за 1 минуту и начните знакомиться прямо сейчас. Живое общение, поиск по ключевым словам и взаимные симпатии!\n\n🚀 Нажмите ЗАПУСТИТЬ, чтобы найти свою пару.').catch(()=>{});
